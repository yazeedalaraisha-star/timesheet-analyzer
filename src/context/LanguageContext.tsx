...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    alertTitle: "تنبيه: وصلوا لحد الرصيد ({threshold} يوم)",
    alertThresholdLabel: "حد التنبيه (يوم):",
    barDays: "الأيام",
    barHours: "الساعات",
    barTaken: "مخصوم",
    ...
    deductEight: "8 ساعات",
    deductTwoHours: "ساعتين كحد أقصى",
    deductNotEnoughBalance: "الرصيد لا يكفي لهذا الخصم",
    ...
    monthlyBtn: "لائحة شهرية",
    monthPicker: "اختر الشهر",
    exportMonthlyTitle: "تنزيل لائحة شهرية جاهزة للطباعة",
    allMonths: "كل الفترات",
    activityLog: "سجل العمليات",
    operatorName: "اسم المستخدم",
    showLog: "عرض السجل",
    hideLog: "إخفاء السجل",
    logLoading: "جارٍ التحميل...",
    logEmpty: "لا توجد عمليات مسجلة بعد",
    unknownOperator: "مجهول",
    op_add: "إضافة",
    op_deduct: "خصم",
    op_delete: "حذف",
    op_edit: "تعديل",
    op_undo: "تراجع",
    op_import: "استيراد",
    op_clearAll: "مسح الكل",
    op_clearEmployee: "مسح موظف",
    adminModeBadge: "وضع الأدمن",
    browseModeBadge: "وضع العرض",
    exitAdminMode: "خروج من وضع الأدمن",
    unlockAdminBtn: "دخول كأدمن",
    lockNoticeTitle: "وضع العرض فقط",
    lockNoticeDesc: "سجّل دخولك كأدمن لإضافة أو خصم العمل الإضافي",
    lockedActionsHint: "أزرار التعديل متاحة للأدمن فقط",
    adminUnlockTitle: "تسجيل دخول الأدمن",
    adminUnlockDesc: "اكتب اسمك وكلمة مرور الأدمن مرة واحدة لفتح صلاحية الإضافة والخصم",
    adminNamePlaceholder: "اسم الأدمن (من يعمل التغيير)",
    errAdminNameRequired: "اكتب اسمك أولاً",
    unlockConfirm: "دخول",
    errAdminWrong: "كلمة مرور خاطئة",
    undoBtn: "تراجع",
    undoTitle: "الرجوع عن آخر عملية",
    ...
    passwordConfirmEdit: "تأكيد التعديل",
  ...
  en: {
    ...
    alertTitle: "Alert: reached balance limit ({threshold} days)",
    alertThresholdLabel: "Alert limit (days):",
    barDays: "Days",
    barHours: "Hours",
    barTaken: "Deducted",
    ...
    deductEight: "8 hours",
    deductTwoHours: "2 hours max",
    deductNotEnoughBalance: "Balance not enough for this deduction",
    ...
    monthlyBtn: "Monthly List",
    monthPicker: "Select month",
    exportMonthlyTitle: "Download printable monthly list",
    allMonths: "All periods",
    ...
    op_undo: "Undo",
    op_import: "Import",
    op_clearAll: "Clear all",
    op_clearEmployee: "Clear employee",
    adminModeBadge: "Admin mode",
    browseModeBadge: "View mode",
    exitAdminMode: "Exit admin mode",
    unlockAdminBtn: "Login as Admin",
    lockNoticeTitle: "View Only",
    lockNoticeDesc: "Log in as admin to add or deduct overtime",
    lockedActionsHint: "Edit actions available to admin only",
    adminUnlockTitle: "Admin Login",
    adminUnlockDesc: "Enter your name and the admin password once to unlock add and deduct",
    adminNamePlaceholder: "Admin name (who is making changes)",
    errAdminNameRequired: "Enter your name first",
    unlockConfirm: "Login",
    errAdminWrong: "Wrong password",
    undoBtn: "Undo",
    ...
    passwordConfirmEdit: "Confirm Edit",
