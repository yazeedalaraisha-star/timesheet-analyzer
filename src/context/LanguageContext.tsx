...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    customStartTime: "وقت الدخول المخصص",
    customEndTime: "وقت الخروج المخصص",
    exportImage: "صورة",
    ...
    passwordConfirmClearAll: "تأكيد مسح الكل",
    passwordClearAllDesc: "أدخل الباسورد لتأكيد مسح السجلات",
    ...
    scheduleTimesUsed: "تم استخدام أوقات الجدول",
    scheduleMatched: "تمت المطابقة مع الجدول",
  ...
  en: {
    ...
    passwordConfirmClearAll: "Confirm Clear All",
    passwordClearAllDesc: "Enter password to confirm clearing records",
    ...
    scheduleTimesUsed: "Schedule times applied",
    scheduleMatched: "Matched with schedule",
